...
public class MenuRuta extends javax.swing.JFrame {
    ...
    private boolean camposCalleSonValidos() {
        if (campoNombreCalle.getText().length() <= 0) {
            ...
            return false;
        } else if (!nombreCalleEsUnico() && btnAnadirCalle.getText().equals("+")) {
            ...
            return false;
        } else if (!esAsignacionDePuntosValida() && btnAnadirCalle.getText().equals("+")) {
    ...
    private void initComponents() {
        ...
        etiquetaDistDesPorPeaton.setText("Des. por Peatón (Dist)");
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                .addComponent(dropSelRuta, javax.swing.GroupLayout.Alignment.LEADING, 0, 132, Short.MAX_VALUE)
                                                .addComponent(campoNombreRuta, javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(campoDistFlujoPeatonal, javax.swing.GroupLayout.Alignment.LEADING))
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                .addComponent(campoDistDesPorPeaton)
    ...
    private void listaCallesRutaValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listaCallesRutaValueChanged
        if (listaCallesRuta.getSelectedIndex() != -1) {
            ...
            int limiteSup = 0;
            if (this.puntos != null) {
                limiteSup = this.puntos.size() - 1;
            } else {
                System.out.println("Puntos null");
            }
            dropPrimerPuntoCalle.removeAllItems();
